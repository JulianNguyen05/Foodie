                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="tab-content ml-1" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="basicInfo" role="tabpanel" aria-labellebdy="basicInfo-tab">
                                        ...
                                        <div class="tab-pane fade" id="connectedServices" role="tabpanel" aria-labellebdy="ConnectedServices-tab">
                                                        ...
                                                        <asp:Repeater ID="rOrders" runat="server">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="lblStatus" runat="server" Text='<%# Eval("Status") %>' CssClass='<%# Eval("Status").ToString() == "Delivered" ? "badge bade-success" : "badge badge-warning" %>'></asp:Label>
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                            <FooterTemplate>
